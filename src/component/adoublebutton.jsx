...
export default function Adoublebutton(props) {
  ...
  return (
    <div ref={btnRef} className="doublebut">
      <button className="butdouble001">{props.buttext01}</button>

      <button className="butdouble002">
        {props.buttext02}
        <svg
