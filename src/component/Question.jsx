...
export default function Question() {
  return (
    <div className="flex flex-col items-center max-w-[1280px] gap-20 py-20 px-5 self-stretch">
      <Atitle
        text03="Find answers to what matters most about using our library services."
        text02="Questions"
      />
      <div className="flex flex-col gap-4 w-full px-12 sm:px-0">
        <Aquetioncadre
      ...
      />
      <button className="flex px-6 py-[10px] justify-center items-center gap-2 rounded-md border border-brand-dark/15 bg-transparent hover:tracking-[3px] active:translate-y-[10px] transition-all duration-500">
        Contact
      </button>
    </div>
  );
