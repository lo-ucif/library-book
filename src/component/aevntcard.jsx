import "./aevntcard-module.css";

export default function Aevntcard(params) {
  return (
    <div className="eventcard">
      <img className="eventphoto" src={params.eventimg} />
      <div className="eventdate">
        <div className="evdate01">{params.feb01}</div>
        <div className="evdate02">{params.feb02}</div>
        <div className="evdate03">{params.feb03}</div>
      </div>
      <div className="infcardevent">
        <div className="eventtxt01">{params.eventt1}</div>
        <div className="eventtxt02">{params.eventt2}</div>
        <div className="eventtxt03">{params.eventt3}</div>
        <button
          style={{
            display: "flex",
            border: "0",
        ...
        >
          <div className="txtlearn">Learn more</div>
          <svg
            className="svglearn"
